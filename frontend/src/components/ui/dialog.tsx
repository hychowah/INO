...
>(({ className, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn('fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-[30px] border border-border/70 bg-card/95 shadow-shell outline-none backdrop-blur-xl', className)}
      {...props}
    />
  </DialogPortal>
));
