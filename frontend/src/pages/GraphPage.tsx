            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm text-slate-300">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link className="inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-200 transition-colors hover:border-white/20 hover:bg-white/10" to="/knowledge">Topics</Link>
                    <Link className="inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-200 transition-colors hover:border-white/20 hover:bg-white/10" to="/knowledge/concepts">Concepts</Link>
                  </div>
                </CardContent>
              </Card>
            </div>
